...
# ---------------------------------------------------------------------------
# DDPM schedule (lightweight, self-contained)
# ---------------------------------------------------------------------------

class DDPMSchedule:
    """Lightweight self-contained DDPM schedule (arbitrary T and beta range)."""
...
class BCPolicy(nn.Module):
    ...
    Args:
        ...
        action_dim: action dimension (default 1; use ACTION_CHUNK for chunks).
